      ...
      001451                        271 _ledInit:
                           ...
                           000001   278 	ar1 = 0x01
                           000000   279 	ar0 = 0x00
      001451 E5 82            [12]  280 	mov	a,dpl
      001453 90 80 7C         [24]  281 	mov	dptr,#_ledInit_redpin_1_3
      001456 F0               [24]  282 	movx	@dptr,a
                                    283 ;	src/led.c:35: redPin = redpin;
      001457 E0               [24]  284 	movx	a,@dptr
      001458 FF               [12]  285 	mov	r7,a
      001459 90 80 79         [24]  286 	mov	dptr,#_redPin
      00145C F0               [24]  287 	movx	@dptr,a
                                    288 ;	src/led.c:36: greenPin = greenpin;
      00145D 90 80 7B         [24]  289 	mov	dptr,#_ledInit_PARM_2
      001460 E0               [24]  290 	movx	a,@dptr
      001461 FE               [12]  291 	mov	r6,a
      001462 90 80 7A         [24]  292 	mov	dptr,#_greenPin
      001465 F0               [24]  293 	movx	@dptr,a
                                    294 ;	src/led.c:39: P0DIR &= ~((1<<redPin) | (1<<greenPin));
      001466 8F F0            [24]  295 	mov	b,r7
      001468 05 F0            [12]  296 	inc	b
      00146A 74 01            [12]  297 	mov	a,#0x01
      00146C 80 02            [24]  298 	sjmp	00105$
      00146E                        299 00103$:
      00146E 25 E0            [12]  300 	add	a,acc
      001470                        301 00105$:
      001470 D5 F0 FB         [24]  302 	djnz	b,00103$
      001473 FF               [12]  303 	mov	r7,a
      001474 8E F0            [24]  304 	mov	b,r6
      001476 05 F0            [12]  305 	inc	b
      001478 74 01            [12]  306 	mov	a,#0x01
      00147A 80 02            [24]  307 	sjmp	00108$
      00147C                        308 00106$:
      00147C 25 E0            [12]  309 	add	a,acc
      00147E                        310 00108$:
      00147E D5 F0 FB         [24]  311 	djnz	b,00106$
      001481 42 07            [12]  312 	orl	ar7,a
      001483 EF               [12]  313 	mov	a,r7
      001484 F4               [12]  314 	cpl	a
      001485 FF               [12]  315 	mov	r7,a
      001486 52 94            [12]  316 	anl	_P0DIR,a
                                    317 ;	src/led.c:41: P0 &= ~((1<<redPin) | (1<<greenPin));
      001488 EF               [12]  318 	mov	a,r7
      001489 52 80            [12]  319 	anl	_P0,a
      00148B 22               [24]  320 	ret
                                    321 ;------------------------------------------------------------
                                    ...
                                    329 ;	-----------------------------------------
      00148C                        330 _ledSet:
      00148C E5 82            [12]  331 	mov	a,dpl
      00148E 90 80 7D         [24]  332 	mov	dptr,#_ledSet_led_1_5
      001491 F0               [24]  333 	movx	@dptr,a
                                    334 ;	src/led.c:46: if(led&LED_RED)
      001492 E0               [24]  335 	movx	a,@dptr
      001493 FF               [12]  336 	mov	r7,a
      001494 30 E0 30         [24]  337 	jnb	acc.0,00105$
                                    338 ;	src/led.c:48: if (value)
      001497 30 05 17         [24]  339 	jnb	_ledSet_PARM_2,00102$
                                    340 ;	src/led.c:49: P0 |= (1<<redPin);
      00149A 90 80 79         [24]  341 	mov	dptr,#_redPin
      00149D E0               [24]  342 	movx	a,@dptr
      00149E FE               [12]  343 	mov	r6,a
      00149F 8E F0            [24]  344 	mov	b,r6
      0014A1 05 F0            [12]  345 	inc	b
      0014A3 74 01            [12]  346 	mov	a,#0x01
      0014A5 80 02            [24]  347 	sjmp	00129$
      0014A7                        348 00127$:
      0014A7 25 E0            [12]  349 	add	a,acc
      0014A9                        350 00129$:
      0014A9 D5 F0 FB         [24]  351 	djnz	b,00127$
      0014AC FE               [12]  352 	mov	r6,a
      0014AD 42 80            [12]  353 	orl	_P0,a
      0014AF 80 16            [24]  354 	sjmp	00105$
      0014B1                        355 00102$:
                                    356 ;	src/led.c:51: P0 &= ~(1<<redPin);
      0014B1 90 80 79         [24]  357 	mov	dptr,#_redPin
      0014B4 E0               [24]  358 	movx	a,@dptr
      0014B5 FE               [12]  359 	mov	r6,a
      0014B6 8E F0            [24]  360 	mov	b,r6
      0014B8 05 F0            [12]  361 	inc	b
      0014BA 74 01            [12]  362 	mov	a,#0x01
      0014BC 80 02            [24]  363 	sjmp	00132$
      0014BE                        364 00130$:
      0014BE 25 E0            [12]  365 	add	a,acc
      0014C0                        366 00132$:
      0014C0 D5 F0 FB         [24]  367 	djnz	b,00130$
      0014C3 F4               [12]  368 	cpl	a
      0014C4 FE               [12]  369 	mov	r6,a
      0014C5 52 80            [12]  370 	anl	_P0,a
      0014C7                        371 00105$:
                                    372 ;	src/led.c:54: if (led & LED_GREEN) 
      0014C7 EF               [12]  373 	mov	a,r7
      0014C8 30 E1 2E         [24]  374 	jnb	acc.1,00111$
                                    375 ;	src/led.c:56: if (value)
      0014CB 30 05 15         [24]  376 	jnb	_ledSet_PARM_2,00107$
                                    377 ;	src/led.c:57: P0 |= (1<<greenPin);
      0014CE 90 80 7A         [24]  378 	mov	dptr,#_greenPin
      0014D1 E0               [24]  379 	movx	a,@dptr
      0014D2 FF               [12]  380 	mov	r7,a
      0014D3 8F F0            [24]  381 	mov	b,r7
      0014D5 05 F0            [12]  382 	inc	b
      0014D7 74 01            [12]  383 	mov	a,#0x01
      0014D9 80 02            [24]  384 	sjmp	00137$
      0014DB                        385 00135$:
      0014DB 25 E0            [12]  386 	add	a,acc
      0014DD                        387 00137$:
      0014DD D5 F0 FB         [24]  388 	djnz	b,00135$
      0014E0 42 80            [12]  389 	orl	_P0,a
      0014E2 22               [24]  390 	ret
      0014E3                        391 00107$:
                                    392 ;	src/led.c:59: P0 &= ~(1<<greenPin);
      0014E3 90 80 7A         [24]  393 	mov	dptr,#_greenPin
      0014E6 E0               [24]  394 	movx	a,@dptr
      0014E7 FF               [12]  395 	mov	r7,a
      0014E8 8F F0            [24]  396 	mov	b,r7
      0014EA 05 F0            [12]  397 	inc	b
      0014EC 74 01            [12]  398 	mov	a,#0x01
      0014EE 80 02            [24]  399 	sjmp	00140$
      0014F0                        400 00138$:
      0014F0 25 E0            [12]  401 	add	a,acc
      0014F2                        402 00140$:
      0014F2 D5 F0 FB         [24]  403 	djnz	b,00138$
      0014F5 F4               [12]  404 	cpl	a
      0014F6 FF               [12]  405 	mov	r7,a
      0014F7 52 80            [12]  406 	anl	_P0,a
      0014F9                        407 00111$:
      0014F9 22               [24]  408 	ret
                                    409 	.area CSEG    (CODE)
                                    410 	.area CONST   (CODE)
                                    411 	.area XINIT   (CODE)
